...
#include "../../Project/AC6/STM32F10x_MC Library/common/MC_type.h"
...
#include "../../../../MCLibrary/src/FrameCommunicationProtocolClass.h"
...
typedef void (*mc_interface_sender)(void*);
/**
* @}
*/
...
void MCP_OnTimeOut(CMCP_UI this)__attribute__ ((deprecated));
void MCP_ReceivedFrame(CMCP_UI this, uint8_t Code, uint8_t *buffer, uint8_t Size);
void MCP_SentFrame(CMCP_UI this, uint8_t Code, uint8_t *buffer, uint8_t Size)__attribute__ ((deprecated));
void MCP_WaitNextFrame(CMCP_UI this)__attribute__ ((deprecated));
void MCP_SendOverrunMeassage(CMCP_UI this)__attribute__ ((deprecated));
void MCP_SendTimeoutMeassage(CMCP_UI this)__attribute__ ((deprecated));
void MCP_SendBadCRCMessage(CMCP_UI this)__attribute__ ((deprecated));
void MCP_custom_init(CMCP_UI this,void (*sender)(uint8_t,uint8_t *,uint8_t));
mc_interface_sender MCP_custom_GetInterface(void);
